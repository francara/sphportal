...
<body>
    ...
    <div id="edit-diaSemanaIntervalo" class="grid_16">
        <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
        </g:if>

        <g:hasErrors bean="${diaSemanaIntervaloInstance}">
            <ul class="errors" role="alert">
                <g:eachError bean="${diaSemanaIntervaloInstance}" var="error">
        ...
        <div class="block" id="forms">
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${diaSemanaIntervaloInstance?.version}" />
