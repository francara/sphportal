...
<body>
    ...
    <div id="show-catalogo" class="grid_16">
        ...
        <div class="block" id="forms">
            <g:form>
                <fieldset>
                    ...
                    <ol class="property-list catalogo">
                        
				<g:if test="${catalogoInstance?.descricao}">
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="catalogo.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${catalogoInstance}" field="descricao"/></span>
